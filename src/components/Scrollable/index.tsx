    ...
    <div className={twMerge("relative w-full", containerClassName)}>
      {type === "arrow" && (
        <button
          ...
          className="absolute left-0 top-1/2 -translate-y-1/2 z-10 p-2 w-12 h-full outline-none"
        >
        </button>
      )}
      <div
      ...
      {type === "arrow" && (
        <button
          ...
          className="absolute right-0 top-1/2 -translate-y-1/2 z-10 p-2 w-12 h-full outline-none"
        >
        </button>
      )}
      {type === "arrow" && oneItemFullFrame && (
        <div className="absolute bottom-2 left-2 bg-gray-100 text-[#021200] text-sm px-3 py-1 rounded-full">
